...
class UpdateFileScreen extends StatefulWidget {
  UpdateFileScreen({super.key, required this.document});
  Document document;
...
class _UpdateFileScreenState extends State<UpdateFileScreen> {
  ...
  void InitData() {
    setState(() {
      _documentNameController.text = widget.document.name;
      _serviceNameController.text = widget.document.serviceName ?? '';
      _file = File(widget.document.path);
                  ...
                  Expanded(
                    child: Column(children: [
                      ...
                      DefaultButton(
                          ...
                          text: "Mettre à jour".toUpperCase(),
                          press: () {}),
                    ]),
                  ),
                ]),
